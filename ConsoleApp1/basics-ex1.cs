class Lasagna
{
    ...
    {
        return this.ExpectedMinutesInOven() - currentMinutesInOven;
    }

    public int PreparationTimeInMinutes(int lasagnaLayers)
    {
        return lasagnaLayers * this.MINUTES_PER_LAYER;
    }

    public int ElapsedTimeInMinutes(int lasagnaLayers, int currentMinutesInOven)
    {
        return this.PreparationTimeInMinutes(lasagnaLayers) + currentMinutesInOven;
    }
}
